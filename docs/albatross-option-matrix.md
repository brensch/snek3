...
- **Historical entry point:** the earlier Albatross trainer used a separate
  proxy-generation path in the archived Python trainer. Current training is
  owned by `crates/snek-train`.
